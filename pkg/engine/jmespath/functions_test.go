...
var functions = GetFunctions(config.NewDefaultConfiguration(false))
...
func Test_Compare(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.jmesPath, func(t *testing.T) {
			jp, err := newJMESPath(functions, tc.jmesPath)
...
func Test_ParseJsonSerde(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc, func(t *testing.T) {
			jp, err := newJMESPath(functions, fmt.Sprintf(`to_string(parse_json('%s'))`, tc))
			assert.NilError(t, err)
...
func Test_ParseJsonComplex(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.input, func(t *testing.T) {
			jp, err := newJMESPath(functions, tc.input)
			assert.NilError(t, err)
...
`,
	...
	for _, tc := range testCases {
		t.Run(tc.input, func(t *testing.T) {
			jp, err := newJMESPath(functions, fmt.Sprintf(`parse_yaml('%s')`, tc.input))
			assert.NilError(t, err)
			result, err := jp.Search("")
			assert.NilError(t, err)
...
func Test_ReplaceAll(t *testing.T) {
	jp, err := newJMESPath(functions, "replace_all('Lorem ipsum dolor sit amet', 'ipsum', 'muspi')")
	assert.NilError(t, err)
...
func Test_Trim(t *testing.T) {
	jp, err := newJMESPath(functions, "trim('¡¡¡Hello, Gophers!!!', '!¡')")
	assert.NilError(t, err)
...
func Test_Split(t *testing.T) {
	jp, err := newJMESPath(functions, "split('Hello, Gophers', ', ')")
	assert.NilError(t, err)
...
func Test_HasPrefix(t *testing.T) {
	jp, err := newJMESPath(functions, "starts_with('Gophers', 'Go')")
	assert.NilError(t, err)
...
func Test_HasSuffix(t *testing.T) {
	jp, err := newJMESPath(functions, "ends_with('Amigo', 'go')")
	assert.NilError(t, err)
...
func Test_RegexMatch(t *testing.T) {
	...
	query, err := newJMESPath(functions, "regex_match('12.*', foo)")
	assert.NilError(t, err)
...
func Test_RegexMatchWithNumber(t *testing.T) {
	...
	query, err := newJMESPath(functions, "regex_match('12.*', abs(foo))")
	assert.NilError(t, err)
...
func Test_PatternMatch(t *testing.T) {
	...
	query, err := newJMESPath(functions, "pattern_match('prefix-*', foo)")
	assert.NilError(t, err)
...
func Test_PatternMatchWithNumber(t *testing.T) {
	...
	query, err := newJMESPath(functions, "pattern_match('12*', abs(foo))")
	assert.NilError(t, err)
...
func Test_RegexReplaceAll(t *testing.T) {
	...
	assert.NilError(t, err)
	query, err := newJMESPath(functions, `regex_replace_all('([Hh]e|G)l', spec.field, '${2}G')`)
	assert.NilError(t, err)
...
func Test_RegexReplaceAllLiteral(t *testing.T) {
	...
	query, err := newJMESPath(functions, `regex_replace_all_literal('[Hh]el?', spec.field, 'G')`)
	assert.NilError(t, err)
...
func Test_LabelMatch(t *testing.T) {
	...
	for i, tc := range testCases {
		t.Run(fmt.Sprintf("case %d", i), func(t *testing.T) {
			...
			query, err := newJMESPath(functions, "label_match(`"+tc.test+"`, metadata.labels)")
			assert.NilError(t, err)
...
func Test_Base64Decode(t *testing.T) {
	jp, err := newJMESPath(functions, "base64_decode('SGVsbG8sIHdvcmxkIQ==')")
	assert.NilError(t, err)
...
func Test_Base64Encode(t *testing.T) {
	jp, err := newJMESPath(functions, "base64_encode('Hello, world!')")
	assert.NilError(t, err)
...
func Test_Base64Decode_Secret(t *testing.T) {
	...
	query, err := newJMESPath(functions, `base64_decode(data.example1)`)
	assert.NilError(t, err)
...
func Test_Lookup(t *testing.T) {
	...
	for i, tc := range testCases {
		t.Run(fmt.Sprintf("case %d", i), func(t *testing.T) {
			query, err := newJMESPath(functions, "lookup(`"+tc.collection+"`,`"+tc.key+"`)")
			assert.NilError(t, err)
...
func Test_Items(t *testing.T) {
	...
	for i, tc := range testCases {
		t.Run(fmt.Sprintf("case %d", i), func(t *testing.T) {
			query, err := newJMESPath(functions, "items(`"+tc.object+"`,`"+tc.keyName+"`,`"+tc.valName+"`)")
			assert.NilError(t, err)
...
func Test_ObjectFromLists(t *testing.T) {
	...
	for i, tc := range testCases {
		t.Run(fmt.Sprintf("case %d", i), func(t *testing.T) {
			query, err := newJMESPath(functions, "object_from_lists(`"+tc.keys+"`,`"+tc.values+"`)")
			assert.NilError(t, err)
			res, err := query.Search("")
			assert.NilError(t, err)
			result, ok := res.(map[string]interface{})
